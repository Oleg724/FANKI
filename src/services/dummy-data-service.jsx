            ...
            notifications: [
                {
                    ...
                    icon: icon14,
                    creationTime: '2020-09-20T09:22',
                    type: '',
                    kind: 'Yазначает вам задачу',
                ...
                {
                    id: 3,
                    from: 'Никифорова Валентина',
                    icon: icon3,
                    creationTime: `${ new Date() }`,
                    type: 'Групповое событие',
                    kind: 'Создаёт событие',
                    text: 'Принять участие в обсуждении текущего проекта.',
                }
            ],
            events: [
                {
                ...
                },
                {
                    ...
                    type: 'news',
                    icon: updatesImage,
                    creationTime: '2020-09-20T12:00:00',
                    comments: '18',
                    likes: '3',
                    likes2: '5',
                    title: 'Здесь будет находиться очень длинный заголовок опубликованной новости в водопаде событий',
                ...
                },
                {
                    ...
                    type: 'company',
                    icon: icon3,
                    creationTime: `2020-09-16T12:00:00`,
                    comments: '',
                    likes: '',
                    likes2: '',
                    title: 'Текст обьявления, который написан от лица компании',
